	...
	useEffect(() => {
		const fetchBookings = async () => {
			try {
				...
				// Usta ulushi hisoblanmagan bu yerda, lekin muvaffaqiyatli xizmatlardan tushgan umumiy tushumini hisoblaymiz.
				...
				<div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
					<div>
						...
						<p className='text-zinc-500 mt-1'>
							Ko'rsatilgan xizmatlardan ishlangan mablag'lar statistikasi.
						</p>
					</div>
				</div>
					...
					{isLoading ? (
									...
									>
										<CardContent className='p-5 flex items-center justify-between'>
											<div className='flex items-center gap-4'>
												...
												<div>
													<p className='font-bold text-zinc-900'>
														{b.clientId?.name || b.guestName || 'Mijoz'}
													</p>
											...
											<div className='text-right'>
												...
												<span className='text-[10px] text-zinc-500 font-medium mt-1 inline-block uppercase'>
													Tushum
												</span>
											</div>
										</CardContent>
						...
						<Card className='border-dashed border-2 bg-transparent shadow-none border-zinc-200'>
							<CardContent className='p-10 text-center text-zinc-500'>
								Hozircha daromadlar tarixi mavjud emas.
							</CardContent>
						</Card>
					)}
				</div>
